    ...
    render() {
        return (
                ...
                <nav className="navbar navbar-expand-lg container mt-2 mb-5" >
                    <Link className="navbar-brand" id="navbar" to="/"><h1>CecilJS <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-braces" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
